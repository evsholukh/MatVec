...
int main(int argc, char **argv) {
    ...
    vector<float> a(array_size), b(array_size);

    size_t bytes_count = sizeof(float) * a.size();
    std::cout << "Vector size: " << bytes_count / (1024 * 1024) << " MB" << std::endl;
